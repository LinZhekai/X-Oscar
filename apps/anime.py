...
def render_mesh_helper(mesh, input_renderer, z_offset=1.0, xmag=0.4, y=0.8, z=1, use_default_color=True):
...
class Animation:
    ...
    def forward_talkshow(self, pose_file, video_save_path, interval=5):
        ...
        imageio.mimsave(video_save_path, out_frames, fps=60 // interval, quality=8, macro_block_size=1)
    ...
    def forward_aist(self, video_save_path, aist_dir="data/aist", interval=5):
        ...
        motion_name = "gWA_sBM_cAll_d25_mWA0_ch01.pkl"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--subject', type=str, required=True, help="subject's name")
    ...
    ckpt_file = f"results/XOscar_{args.subject}/{args.prompt}/checkpoints/XOscar_{args.subject}_ep0200.pth"
